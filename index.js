...
if(i==0){
 ...
 function renderData() {
  ...
  {
      if(id==videoData[i].id)
    {
      $("#video-player").attr("src", ("https://player.vimeo.com/video/" + videoData[i].vimeoId));
      $("#views-count").html(videoData[i].views)
      $("#video-title").html(videoData[i].title)
      $("#video-description").html(videoData[i].description)
